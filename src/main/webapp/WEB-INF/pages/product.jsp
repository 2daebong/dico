...
<div class="container">
    <div class="main_text">
        <button class="btn btn-success btn_register_shop" data-toggle="modal" data-target="#regist_modal">신규 Product 등록</button>
...
//                    if(err) {
//                        results.innerHTML = '업로드 실패.';
//                    } else {
//                        var fileName = upload.body.name;
//                        results.innerHTML = fileName + ' 업로드 성공';
//
//                        sImageUrl = bucket.endpoint.href + BUCKET_NAME + '/' + fileName;
//                    }
//                });
//
//            } else {
